...
import { userFlowAreaCatalogStore, useUserFlowAreaCatalog } from '@/src/state/user-flow-area-catalog.ts';
...
export const SettingsPage = () => {
  ...
  const canManageAreaCatalog = Boolean(roleSlug && roleSlug !== 'viewer');
