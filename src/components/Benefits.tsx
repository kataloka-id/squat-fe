...
const Features: React.FC = () => {
    const features = [
        ...
        },
        {
            ...
            description: "Tampilan dan fungsi yang dapat digunakan di berbagai macam jenis perangkat seperti PC, Smartphone, dan Tablet."
        }
    ];

    return (
        <section id="benefits" className="py-16 lg:py-24 bg-white border-gray-50">
            <div className="container mx-auto px-4 lg:px-20">
                <div className="max-w-3xl mb-12">
                    <div className="text-sky-600 font-bold uppercase tracking-widest text-[10px] mb-2">Layanan Digital Kami</div>
